...
## Ønsket oppførsel
1. Jeg ønsker filer som lager funksjonalitet som følger:
- En side som viser meny. Siden skal helst ha tilsvarende funksjonalitet som antydet i `_basis/docs/BokMeny.png`.
- En side som viser bøkene i biblioteket. Siden skal helst ha tilsvarende funksjonalitet som antydet i `_basis/docs/Bokliste.png`. Bøkene er i tabellen `bokbook`
- En side som viser detaljene i hver bok, samt plassering i biblioteket. Siden skal helst ha tilsvarende funksjonalitet som antydet i `_basis/docs/BokDetaljPlass.png`.
- En side som viser forfatterne og deres bøker i biblioteket. Siden skal helst ha tilsvarende funksjonalitet som antydet i `_basis/docs/ForfatterBoker.png`. Forfatterne er i tabellen `bokauthor`. Forfatterens er koblet til sine bøker i tabellen `bokauthorbook`.
- En side som viser kategorienes bøker i biblioteket. Siden skal helst ha tilsvarende funksjonalitet som antydet i `_basis/docs/KategoriBoker.png`.
